    ...
    return (
        <div className=' bg-white p-6 overflow-x-auto rounded-lg shadow-md '>
            <div className='flex justify-between items-center'>
                ...
                <button className='px-4 py-3 bg-green-400 text-white text-lg rounded-md cursor-pointer' type='submit'>View Delivery Boys</button>
            </div>
            ...
            <form action="" >
                ...
                <div className=' flex flex-col'>
                    ...
                    type="text" name='name' className='bg-gray-300 w-full rounded-md p-2' />
                </div>
                {/* date fo birth */}
                <div>
                    ...
                    type="date" className='bg-gray-300 w-full rounded-md p-2' />
                </div>
                {/* mobile number */}
                <div>
                    ...
                    type="number" className='bg-gray-300 w-full rounded-md p-2'/>
                </div>
                {/* email */}
                <div>
                    <label htmlFor="" className='block mb-2 font-medium'>Email</label>
                    <input name='email' value={formData.email} onChange={handleInputChange}
                    type="email" className='bg-gray-300 w-full rounded-md p-2'/>
                </div>
                {/* password */}
                <div>
                    ...
                    type="password" className='bg-gray-300 w-full rounded-md p-2'/>
                </div>
                {/* confirm password */}
                <div>
                ...
                <div>
                    ...
                    type="text" className='bg-gray-300 w-full rounded-md p-2'/>
                </div>
                {/* bank name */}
                <div>
                ...
                <div>
                    ...
                    className='bg-gray-300 w-full rounded-md p-2' type="text" />
                </div>
                <div>
                ...
                <div {...getRootProps()} className='w-full bg-gray-300 border-dashed border-2 border-gray-400 p-10 rounded-xl cursor-pointer'>
                ...
                <div className='grid grid-cols-1 gap-6 mt-6'>
                    <button onClick={handleSubmit} type='submit' className='bg-green-500 text-white rounded-md font-medium cursor-pointer'>Save</button>
                    <button onClick={handleClear}  className='bg-red-500 text-white rounded-md font-medium cursor-pointer'>Clear</button>
                </div>
                </div>
            </form>
        </div>
